...
def draft_email(client, email, config):
    ...
    if relation:
        prompt = f"Draft an email responding to the email '{email.subject}' from {relation} ({email.sender}). The body of the email is: {email.body}. Please only include the body of the email."
    else:
        prompt = f"Draft an email responding to the email '{email.subject}' from {email.sender}. The body of the email is: {email.body}. Please only include the body of the email."
